...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1045, 851)
        Form.setStyleSheet("background-color:qlineargradient(spread:pad, x1:0.221, y1:0.79, x2:0.818, y2:0.165, stop:0 rgba(77, 37, 162, 255), stop:1 rgba(122, 173, 255, 255))")
        ...
        self.frame_13.setStyleSheet("background-color:rgba(255,255,255,30);\n"
...
"border-radius: 7px")
        ...
        self.label_7.setStyleSheet("background-color:qlineargradient(spread:reflect, x1:0.518955, y1:0.488, x2:0.501, y2:0, stop:0 rgba(0, 219, 131, 255), stop:0.994318 rgba(59, 115, 255, 255))")
        self.label_7.setObjectName("label_7")
        self.verticalLayout_15.addWidget(self.label_7, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.btn_register.setStyleSheet("background-color:qlineargradient(spread:reflect, x1:0.518955, y1:0.488, x2:0.501, y2:0, stop:0 rgba(0, 219, 131, 255), stop:0.994318 rgba(59, 115, 255, 255))")
        ...
        self.btn_login.setStyleSheet("background-color:qlineargradient(spread:reflect, x1:0.518955, y1:0.488, x2:0.501, y2:0, stop:0 rgba(0, 219, 131, 255), stop:0.994318 rgba(59, 115, 255, 255))")
        ...
        self.error_label.setStyleSheet("background-color:rgba(255,255,255,30);\n"
"border: 1px solid rgba(255, 255, 255, 30);\n"
"border-radius: 7px")
        ...
        self.frame_11.setStyleSheet("background-color:rgba(255,255,255,30);\n"
"border: 1px solid rgba(255, 255, 255, 30);\n"
"border-radius: 7px")
        ...
        self.label.setStyleSheet("background-color:qlineargradient(spread:reflect, x1:0.518955, y1:0.488, x2:0.501, y2:0, stop:0 rgba(0, 219, 131, 255), stop:0.994318 rgba(59, 115, 255, 255))")
...
"border-radius: 7px")
        ...
        self.lineEdit_town.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.btn_get_weather.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.label_weather.setStyleSheet("background-color:qlineargradient(spread:reflect, x1:0, y1:0, x2:0.995, y2:1, stop:0 rgba(0, 201, 219, 255), stop:0.994318 rgba(59, 115, 255, 255))qlineargradient(spread:reflect, x1:0, y1:0, x2:0.995, y2:1, stop:0 rgba(0, 219, 131, 255), stop:0.994318 rgba(59, 115, 255, 255))")
...
"border-radius: 7px")
        ...
        self.label_2.setStyleSheet("background-color:qlineargradient(spread:reflect, x1:0.518955, y1:0.488, x2:0.501, y2:0, stop:0 rgba(0, 219, 131, 255), stop:0.994318 rgba(59, 115, 255, 255))")
...
"border-radius: 7px")
        ...
        self.label_3.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.lineEdit_source.setStyleSheet("background-color:rgb(255, 255, 255)")
        ...
        self.btn_load_source_file.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.btn_load_local_file.setStyleSheet("background-color:rgb(189, 232, 255)")
...
"border-radius: 7px")
        ...
        self.btn_visual.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.error_label_loadfile.setStyleSheet("background-color:rgb(255, 255, 255)")
        ...
        self.frame_4.setStyleSheet("background-color:rgba(255,255,255,30);\n"
"border: 1px solid rgba(255, 255, 255, 30);\n"
"border-radius: 7px")
        ...
        self.label_5.setStyleSheet("background-color:qlineargradient(spread:reflect, x1:0.518955, y1:0.488, x2:0.501, y2:0, stop:0 rgba(0, 219, 131, 255), stop:0.994318 rgba(59, 115, 255, 255))")
        ...
        self.frame_5.setStyleSheet("background-color:rgba(255,255,255,30);\n"
"border: 1px solid rgba(255, 255, 255, 30);\n"
"border-radius: 7px")
        ...
        self.edit_town_visual.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.radio_btn_graph.setStyleSheet("background-color:rgb(189, 232, 255)")
        self.radio_btn_graph.setChecked(True)
        ...
        self.radio_btn_bar.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.frame_8.setStyleSheet("background-color:rgba(255,255,255,30);\n"
"border: 1px solid rgba(255, 255, 255, 30);\n"
"border-radius: 7px")
        ...
        self.start = QtWidgets.QLineEdit(parent=self.frame_8)
        self.start.setMinimumSize(QtCore.QSize(200, 30))
        self.start.setMaximumSize(QtCore.QSize(200, 16777215))
        self.start.setStyleSheet("background-color:rgb(189, 232, 255)")
        self.start.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.start.setObjectName("start")
        self.horizontalLayout_8.addWidget(self.start)
        self.finish = QtWidgets.QLineEdit(parent=self.frame_8)
        self.finish.setMinimumSize(QtCore.QSize(200, 30))
        self.finish.setMaximumSize(QtCore.QSize(200, 16777215))
        self.finish.setStyleSheet("background-color:rgb(189, 232, 255)")
        self.finish.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.finish.setObjectName("finish")
        self.horizontalLayout_8.addWidget(self.finish)
        self.verticalLayout_3.addWidget(self.frame_8)
        self.frame_9 = QtWidgets.QFrame(parent=self.tab)
        self.frame_9.setStyleSheet("background-color:rgba(255,255,255,30);\n"
"border: 1px solid rgba(255, 255, 255, 30);\n"
"border-radius: 7px")
        ...
        self.btn_analyze.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.visual_label.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.frame_12.setStyleSheet("background-color:rgba(255,255,255,30);\n"
"border: 1px solid rgba(255, 255, 255, 30);\n"
"border-radius: 7px")
        ...
        self.label_6.setStyleSheet("background-color:qlineargradient(spread:reflect, x1:0.518955, y1:0.488, x2:0.501, y2:0, stop:0 rgba(0, 219, 131, 255), stop:0.994318 rgba(59, 115, 255, 255))")
        ...
        self.label_town_graph.setStyleSheet("background-color:rgb(189, 232, 255)")
        self.label_town_graph.setObjectName("label_town_graph")
        self.verticalLayout_7.addWidget(self.label_town_graph, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 132, 862))
        ...
        self.label_8.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.frame_14.setMinimumSize(QtCore.QSize(0, 400))
        self.frame_14.setMaximumSize(QtCore.QSize(16777215, 400))
        ...
        self.verticalLayout_18.addLayout(self.graph_layout)
        self.temp_stats = QtWidgets.QLabel(parent=self.frame_14)
        self.temp_stats.setMaximumSize(QtCore.QSize(16777215, 15))
        self.temp_stats.setText("")
        self.temp_stats.setObjectName("temp_stats")
        self.verticalLayout_18.addWidget(self.temp_stats)
        self.line_2 = QtWidgets.QFrame(parent=self.frame_14)
        ...
        self.label_9.setStyleSheet("background-color:rgb(189, 232, 255)")
        ...
        self.frame_15.setMaximumSize(QtCore.QSize(16777215, 400))
        ...
        self.verticalLayout_19.addLayout(self.graph_layout_2)
        ...
        self.line_4 = QtWidgets.QFrame(parent=self.frame_15)
...
"border-radius: 7px")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_7.setText(_translate("Form", "Система регистрации"))
        ...
        self.start.setPlaceholderText(_translate("Form", "Начало"))
        self.finish.setPlaceholderText(_translate("Form", "Конец"))
        ...
        self.label_8.setText(_translate("Form", "Температура, цельсии"))
        self.label_9.setText(_translate("Form", "Влажность, проценты"))
