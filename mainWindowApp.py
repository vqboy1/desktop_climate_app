...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.sourceEdit_2 = QtWidgets.QLineEdit(parent=self.frame_6)
        self.sourceEdit_2.setMinimumSize(QtCore.QSize(0, 20))
        self.sourceEdit_2.setMaximumSize(QtCore.QSize(480, 16777215))
        self.sourceEdit_2.setObjectName("sourceEdit_2")
        self.verticalLayout_10.addWidget(self.sourceEdit_2)
        ...
        self.btn_load_source_file_2 = QtWidgets.QPushButton(parent=self.frame_7)
        self.btn_load_source_file_2.setMinimumSize(QtCore.QSize(200, 40))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_load_source_file_2.setFont(font)
        self.btn_load_source_file_2.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.btn_load_source_file_2.setObjectName("btn_load_source_file_2")
        self.verticalLayout_11.addWidget(self.btn_load_source_file_2, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.btn_load_local_file_2 = QtWidgets.QPushButton(parent=self.frame_7)
        self.btn_load_local_file_2.setMinimumSize(QtCore.QSize(200, 40))
        self.btn_load_local_file_2.setMaximumSize(QtCore.QSize(300, 40))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.btn_load_local_file_2.setFont(font)
        self.btn_load_local_file_2.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.btn_load_local_file_2.setObjectName("btn_load_local_file_2")
        self.verticalLayout_11.addWidget(self.btn_load_local_file_2, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.btn_visual_2 = QtWidgets.QPushButton(parent=self.frame_3)
        self.btn_visual_2.setMinimumSize(QtCore.QSize(0, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.btn_visual_2.setFont(font)
        self.btn_visual_2.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.btn_visual_2.setObjectName("btn_visual_2")
        self.verticalLayout_8.addWidget(self.btn_visual_2, 0, QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.error_label_2 = QtWidgets.QLabel(parent=self.frame_3)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.error_label_2.setFont(font)
        self.error_label_2.setObjectName("error_label_2")
        self.verticalLayout_8.addWidget(self.error_label_2, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignBottom)
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_load_source_file_2.setText(_translate("Form", "Загрузить ссылку"))
        self.btn_load_local_file_2.setText(_translate("Form", "Загрузить файл (CSV, XLSX)"))
        self.btn_visual_2.setText(_translate("Form", "Визуализация"))
        self.error_label_2.setText(_translate("Form", "Выберите файлы или вставьте ссылку для загрузки"))
