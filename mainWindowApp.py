...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_town_graph.setMinimumSize(QtCore.QSize(0, 15))
        self.label_town_graph.setMaximumSize(QtCore.QSize(16777215, 15))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -269, 901, 870))
        ...
        self.humid_stats = QtWidgets.QLabel(parent=self.frame_15)
        self.humid_stats.setMaximumSize(QtCore.QSize(16777215, 15))
        self.humid_stats.setText("")
        self.humid_stats.setObjectName("humid_stats")
        self.verticalLayout_19.addWidget(self.humid_stats)
